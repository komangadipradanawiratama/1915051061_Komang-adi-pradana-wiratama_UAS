				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="proses/crud.php?aksi=edit" method="POST">
							...
							<div class="form-group">
								<label>Agama</label>
								<input type="text" value="<?php echo $hasil['agama']; ?>" class="form-control" name="agama">
							</div>
							<div class="form-group">
								<label>Nomor KTP</label>
								<input type="text" value="<?php echo $hasil['KTP']; ?>" class="form-control" name="KTP">
							</div>
							<div class="form-group">
								<label>Nama Ibu</label>
								<input type="text" value="<?php echo $hasil['KTP']; ?>" class="form-control" name="nama_ibu">
							</div>
							<div class="form-group">
								<label>Email</label>
